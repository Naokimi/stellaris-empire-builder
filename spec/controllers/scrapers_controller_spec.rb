...
RSpec.describe ScrapersController, type: :controller do
  context 'Civics' do
    it 'scrapes standard' do
      ...
      scraped_array = ScrapersController.civics_scraper(0, 6)
    ...
    it 'scrapes corporate' do
      ...
      scraped_array = ScrapersController.civics_scraper(2, 4)
      expect(scraped_array.first).to eq(result)
    end
    it 'scrapes hive mind' do
      ...
      scraped_array = ScrapersController.civics_scraper(3, 4)
      expect(scraped_array.first).to eq(result)
    end
    it 'scrapes machine intelligence' do
      ...
      scraped_array = ScrapersController.civics_scraper(4, 4)
      expect(scraped_array.first).to eq(result)
    end
  end
  ...
  context 'Traits' do
    it 'scrapes standard and biological' do
      ...
      scraped_array = ScrapersController.traits_scraper(0, 7)
      expect(scraped_array.first).to eq(result)
    end
    it 'scrapes lithoid' do
      ...
      scraped_array = ScrapersController.traits_scraper(1, 6)
      expect(scraped_array.first).to eq(result)
    end
    it 'scrapes robotic' do
      ...
      scraped_array = ScrapersController.traits_scraper(-1, 7)
      expect(scraped_array.first).to eq(result)
    end
  end
end
